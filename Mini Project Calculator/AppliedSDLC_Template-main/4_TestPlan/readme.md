...
|-------------|--------------------------------------------------------------|------------|-------------|----------------|------------------|
|  H_01       |Distance conversion- Converting unit distances from one input to the other|  10metre | 32.8 feet | 32.8 feet |Requirement based |
...
|  L_02       |Metre to Foot Conversion | 20 metre | 65.6168 feet | 65.6168 feet |Requirement based |
